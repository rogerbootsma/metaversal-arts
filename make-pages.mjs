...
const pages={
 ...
 <h2>Worlds in orbit</h2><p>An original, densely textured procedural planet with turquoise and copper strata. Twelve small textured moons follow individual, inclined rings, with fine orbital dust and occasional comet trails.</p>
...
const projectHead=home.slice(home.indexOf('<head>'),home.indexOf('</head>')+7)
 ...
 .replace('</head>','<link rel="stylesheet" href="./projects.css?v=granular-moons-1">\n<script type="module" src="./projects-scene.js?v=granular-moons-1"></script>\n</head>');
